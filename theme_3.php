<div class="wpcu-product <?php echo ( 'carousel' == $layout ) ? 'swiper-slide' : ''; ?>">
    <div class="wpcu-product__content">
        ...
        <div class="wpcu-product__details">
            ...
            <!-- FYXED -->
            <?php if ( has_term( 'apple', 'product_cat', get_the_ID() ) ) : ?>
            ...
            <?php else : ?>
                ...
                <div class="wpcu-product__web_price">
                    <?php echo do_shortcode('[alg_show_checkout_fees_full_info]'); ?>
                </div>

                <?php 
                    mostrar_tag_preventa(); 

                    echo do_shortcode('[yith_quick_view product_id="' . get_the_ID() . '" type="button" label="Quick View"]');
                ?> 
                <!-- FYXED -->
